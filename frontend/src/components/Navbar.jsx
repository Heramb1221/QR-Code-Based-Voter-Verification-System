                ...
                <div className='hidden md:flex items-center space-x-3 mr-5'>
                    ...
                    {isLoggedIn && userType === 'admin' && (
                        <>
                            ...
                            <NavLink to='/scanner' className="flex items-center bg-white text-[#1a73e8] hover:bg-gray-100 py-2 px-3 rounded-md focus:outline-none focus:ring-2 focus:ring-[#1a73e8] focus:ring-opacity-50">
                                Scan QR
                            </NavLink>
                        </>
                    )}
